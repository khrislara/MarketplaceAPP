...
import java.util.List;
public class GaleriaImagenAdapter extends
        RecyclerView.Adapter<GaleriaImagenAdapter.ImageViewHolder> {
    ...
    public GaleriaImagenAdapter(Context context, List<Uri> listaImagenesUri,
                                OnImageInteractionListener listener) {
    ...
    public ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_galeria_imagen, parent,
                false);
